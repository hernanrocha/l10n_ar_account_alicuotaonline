...
class IngresosBrutosArbaRetencion(models.Model):
    ...
    # Campo 3 - Numero Sucursal
    numero_sucursal = fields.Char(string="Numero Sucursal")
...
class IngresosBrutosArbaPercepcion(models.Model):
    ...
    letra_cbte = fields.Selection(selection=[
        ('A', 'A'),
        ('B', 'B'),
        ('C', 'C'),
        (' ', '<blanco>')
    ...
    pto_venta = fields.Char(string="Punto de Venta")
